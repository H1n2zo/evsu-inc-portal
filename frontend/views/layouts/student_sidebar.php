...
<nav class="sidebar">
  ...
  <a href="<?= $view->url('student/dashboard.php') ?>" class="nav-item <?= $activePage==='dashboard'?'active':'' ?>">
  ...
  <a href="<?= $view->url('student/apply.php') ?>" class="nav-item <?= $activePage==='apply'?'active':'' ?>">
  ...
  <a href="<?= $view->url('student/applications.php') ?>" class="nav-item <?= $activePage==='applications'?'active':'' ?>">
