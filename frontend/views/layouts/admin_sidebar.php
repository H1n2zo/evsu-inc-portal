...
<nav class="sidebar">
  ...
  <a href="<?= $view->url('admin/dashboard.php') ?>" class="nav-item <?= $activePage==='dashboard'?'active':'' ?>">
  ...
  <a href="<?= $view->url('admin/applications.php') ?>" class="nav-item <?= $activePage==='applications'?'active':'' ?>">
  ...
  <a href="<?= $view->url('admin/users.php') ?>" class="nav-item <?= $activePage==='users'?'active':'' ?>">
  ...
  <a href="<?= $view->url('admin/rbac.php') ?>" class="nav-item <?= $activePage==='rbac'?'active':'' ?>">
  ...
  <a href="<?= $view->url('admin/modules.php') ?>" class="nav-item <?= $activePage==='modules'?'active':'' ?>">
  ...
  <a href="<?= $view->url('admin/settings.php') ?>" class="nav-item <?= $activePage==='settings'?'active':'' ?>">
  ...
  <a href="<?= $view->url('admin/logs.php') ?>" class="nav-item <?= $activePage==='logs'?'active':'' ?>">
  ...
  <div class="sidebar-footer">
    ...
    <a href="<?= $view->url('logout.php') ?>" style="display:flex;align-items:center;gap:6px;font-size:12px;color:rgba(255,255,255,0.4);margin-top:0.75rem;text-decoration:none;">
