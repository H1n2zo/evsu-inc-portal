<?php
// views/admin/application_view.php
...
<main class="main-content">
  <div class="top-bar">
    <div>
      ...
      <p><?= $view->e($app['full_name']) ?> — <?= $view->e($app['subject_name']) ?></p>
    </div>
    <?php
    ...
    <div style="display:flex;align-items:center;gap:0.75rem;">
      ...
      <a href="<?= $view->url('admin/applications.php') ?>" class="btn-sm">← Back</a>
    </div>
  </div>
    ...
    <div class="content-card">
      ...
      <div class="card-body" style="font-size:13.5px;">
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr><td style="color:var(--gray-400);padding:5px 0;width:40%;"><?= $view->e($l) ?></td><td style="padding:5px 0;font-weight:500;"><?= $view->e($v) ?></td></tr>
          <?php endforeach; ?>
        </table>
      </div>
    </div>
    ...
    <div class="content-card">
      ...
      <div class="card-body" style="font-size:13px;">
        ...
        <div style="margin-bottom:0.875rem;padding-bottom:0.875rem;border-bottom:1px solid var(--gray-100);">
          ...
          <?php if($app['instructor_grade']): ?><div>Grade: <strong><?= $view->e($app['instructor_grade']) ?></strong></div><?php endif; ?>
          <?php if($app['instructor_remarks']): ?><div style="color:var(--gray-400);font-size:12px;"><?= $view->e($app['instructor_remarks']) ?></div><?php endif; ?>
        ...
        <div style="margin-bottom:0.875rem;padding-bottom:0.875rem;border-bottom:1px solid var(--gray-100);">
          ...
          <?php if($app['dept_head_remarks']): ?><div style="color:var(--gray-400);font-size:12px;"><?= $view->e($app['dept_head_remarks']) ?></div><?php endif; ?>
        ...
        <div style="margin-bottom:0.875rem;padding-bottom:0.875rem;border-bottom:1px solid var(--gray-100);">
          ...
          <div>O.R. No.: <strong><?= $view->e($app['or_number']) ?></strong></div>
          <?php if($app['receipt_filename']): ?><a href="<?= $view->asset('uploads/') . $view->e($app['receipt_filename']) ?>" target="_blank" class="btn-sm" style="margin-top:6px;">View Receipt</a><?php endif; ?>
        ...
        <div>
          ...
          <?php if($app['registrar_remarks']): ?><div style="color:var(--gray-400);font-size:12px;"><?= $view->e($app['registrar_remarks']) ?></div><?php endif; ?>
        ...
        <div class="alert alert-danger" style="margin-top:0.75rem;"><strong>Rejection Reason:</strong> <?= $view->e($app['rejection_reason']) ?></div>
        <?php endif; ?>
      </div>
    </div>
  </div>
