...
<nav class="sidebar">
  ...
  <a href="/evsu_inc_portal/admin/dashboard.php" class="nav-item <?= $activePage==='dashboard'?'active':'' ?>">
  ...
  <a href="/evsu_inc_portal/admin/applications.php" class="nav-item <?= $activePage==='applications'?'active':'' ?>">
  ...
  <a href="/evsu_inc_portal/admin/users.php" class="nav-item <?= $activePage==='users'?'active':'' ?>">
  ...
  <a href="/evsu_inc_portal/admin/rbac.php" class="nav-item <?= $activePage==='rbac'?'active':'' ?>">
  ...
  <a href="/evsu_inc_portal/admin/modules.php" class="nav-item <?= $activePage==='modules'?'active':'' ?>">
  ...
  <a href="/evsu_inc_portal/admin/settings.php" class="nav-item <?= $activePage==='settings'?'active':'' ?>">
  ...
  <a href="/evsu_inc_portal/admin/logs.php" class="nav-item <?= $activePage==='logs'?'active':'' ?>">
