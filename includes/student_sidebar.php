...
<nav class="sidebar">
  ...
  <a href="/evsu_inc_portal/student/dashboard.php" class="nav-item <?= $activePage==='dashboard'?'active':'' ?>">
  ...
  <a href="/evsu_inc_portal/student/apply.php" class="nav-item <?= $activePage==='apply'?'active':'' ?>">
  ...
  <a href="/evsu_inc_portal/student/applications.php" class="nav-item <?= $activePage==='applications'?'active':'' ?>">
